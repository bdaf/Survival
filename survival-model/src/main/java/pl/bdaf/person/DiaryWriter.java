...
public class DiaryWriter {
    ...
    static String describe(Person aPerson){
        ...
        if (aPerson.getHydrationPoints() < 3) diary.append(aPerson.getName() + randomThreeStrings(" is really thirsty.\n"," would gladly drink glass of water.\n"," realised that she wants water.\n"));
        else if(aPerson.getHydrationPoints() < 2) diary.append(aPerson.getName() + randomThreeStrings(" won't survive next day without water!\n"," can't live longer without water!\n"," will die soon of dryness...\n"));
        if (aPerson.getSatietyPoints() < 5) diary.append(aPerson.getName() + randomThreeStrings(" would gladly eat anything.\n"," dreams about tasty meal.\n"," realised that she wants even this soup.\n"));
        else if (aPerson.getSatietyPoints() < 3) diary.append(aPerson.getName() + randomThreeStrings(" is starving! Next day lived would be a miracle!\n"," will die soon because of lack of food...\n"," can't make next day without food!\n"));
        if (aPerson.getCheerfulness() < 10) diary.append( aPerson.getName() +  randomThreeStrings(" is bored.\n"," wants to go for expedition.\n", " would gladly do anything.\n"));
        else if (aPerson.getCheerfulness() < 5) diary.append(aPerson.getName() + randomThreeStrings(" will go crazy in this shelter!\n"," is going to go for expedition or die....\n", " will soon die of boredom!\n"));
